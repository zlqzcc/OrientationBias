...
subplot(3, 2, 3);
boxplot([1./allPara_td(:, 2), 1./allPara_td(:, 4), 1./allPara_td(:, 6)], 'Labels',{'woFB', 'wFB1', 'wFB2'});
ylim([0, 0.03]);
...
subplot(3, 2, 4);
boxplot([1./allPara_asd(:, 2), 1./allPara_asd(:, 4), 1./allPara_asd(:, 6)], 'Labels',{'woFB', 'wFB1', 'wFB2'});
ylim([0, 0.03]);
